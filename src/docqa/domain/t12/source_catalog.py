...
T12_SOURCES: tuple[RegulationSource, ...] = (
    ...
    RegulationSource(
        source_id="guide.aspca_people_foods",
        ...
        checked_on=date(2026, 6, 17),
        ingestion_status="summary_indexed",
        notes="초콜릿, 카페인, 포도, 양파류, 자일리톨 등 사람 음식 섭취 사고 대응 근거.",
    ),
    RegulationSource(
        source_id="guide.aspca_household_products",
        ...
        checked_on=date(2026, 6, 17),
        ingestion_status="summary_indexed",
        notes="세제, 위생용품, 세탁용품 등 가정 내 독성 노출 대응 근거.",
    ),
    RegulationSource(
        source_id="guide.cdc_pet_emergency",
        ...
        checked_on=date(2026, 6, 17),
        ingestion_status="summary_indexed",
        notes="재난 대비, 대피 계획, 반려동물 비상 키트 구성 근거.",
    ),
    RegulationSource(
        source_id="guide.cdc_pet_travel",
        title="Pet Travel Safety",
        publisher="U.S. Centers for Disease Control and Prevention",
        source_kind="public_health_guide",
        authority_level="official_guidance",
        url="https://www.cdc.gov/healthy-pets/travel/index.html",
        checked_on=date(2026, 6, 17),
        ingestion_status="summary_indexed",
        notes="자동차·항공 이동, 예방접종, 이동장, 여행 서류 준비 근거.",
    ),
    RegulationSource(
        source_id="guide.fda_pet_food_safety",
        ...
        checked_on=date(2026, 6, 17),
        ingestion_status="summary_indexed",
        notes="반려동물 사료 안전, 리콜, 제품 문제 신고 준비 근거.",
    ),
)
